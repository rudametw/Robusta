...
run() {	
	...
	echo "exec $JAVA $JAVA_OPTS $OPTS -classpath \"$CLASSPATH\" jline.ConsoleRunner org.ow2.chameleon.core.Main \"$@\""
    	#exec       $JAVA $JAVA_OPTS $OPTS -classpath  "$CLASSPATH"  jline.ConsoleRunner org.ow2.chameleon.core.Main  "$@"
    	exec       $JAVA $JAVA_OPTS $OPTS -classpath  "$CLASSPATH"  jline.ConsoleReader org.ow2.chameleon.core.Main  "$@"
}
